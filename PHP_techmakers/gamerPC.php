...
<main style="background-image: url(imagens/bg-body.jpg); ;  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;"> 
  ...
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="imagens/pc-gamer-battlebox-essential-1530194532636_1000x1000+fill_ffffff.jpg" alt="Imagem do computador desktop"></a>
              <div class="card-body">
                <h4 class="card-title text-center">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="imagens/pc-gamer-arctic-1559070217590_1000x1000+fill_ffffffs.png" alt="Imagem do computador desktop"></a>
              <div class="card-body">
                <h4 class="card-title text-center">
