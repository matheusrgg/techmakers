            ...
            <!-- <img class="card-img-top" src="imagens/nootbokGamerF.jpg" alt=""></a> -->
             <div class="card-body">
               <h3 class="card-title text-center">
                 <a href="/estiloUsuario/UsoProfissional/Preferencia/Geral_Desktop">Computador Desktop</a>
               </h3>
               <p class="card-text text-center">Para você que prioriza uma tela maior, <br> alto desempenho e custo-benefício.</p>
             </div>
             <div class="card-footer text-center">
                <a href="/estiloUsuario/UsoProfissional/Preferencia/Geral_Desktop" class="btn btn-success">Escolher</a>
             </div>
          </div>
        </div>     
       ...
       <!--      <a><img class="card-img-top" src="imagens/pcGamerf.jpg" alt=""></a> -->
            <div class="card-body">
              <h3 class="text-dark text-center">
                <a href="/estiloUsuario/UsoProfissional/Preferencia/Geral_Notebook">Notebook</a>
              </h3>
              <p class="card-text text-center">Para você que precisa de mobilidade <br>e ter sempre um computador a disposição.</p>
            </div>
            <div class="card-footer text-center">
                <a href="/estiloUsuario/UsoProfissional/Preferencia/Geral_Notebook" class="btn btn-success">Escolher</a>
             </div>
          </div>
        </div>
