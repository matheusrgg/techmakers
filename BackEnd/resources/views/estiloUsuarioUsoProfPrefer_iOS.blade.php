    ...
    <div class="text-center">
      ...
      <div class="container-fluid pb-5">
          ...
          <div class="card h-100">
            ...
            <!-- <img class="card-img-top" src="imagens/nootbokGamerF.jpg" alt=""></a> -->
             ...
             <div class="card-footer text-center">
                <a href="/estiloUsuario/UsoProfissional/Preferencia/iOS_Desktop" class="btn btn-success">Escolher</a>
             </div>
          </div>
        </div>
       ...
       <!--      <a><img class="card-img-top" src="imagens/pcGamerf.jpg" alt=""></a> -->
            ...
            <div class="card-footer text-center">
                <a href="/estiloUsuario/UsoProfissional/Preferencia/iOS_Notebook" class="btn btn-success">Escolher</a>
             </div>
          </div>
        </div>
