...
<div class="py-4 text-center text-white h-100 align-items-center d-flex"
    ...
    <div class="text-center">
      ...
      <div class="container-fluid pb-5">
        ...
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-success"><b>Computadores notebooks para desenvolvimento iOS</b></h1>
          </div>
        </div>

        <!-- Início dos Computadores NOTEBOOKS para DESENVOLVIMENTO iOS -->
<div class="container">
...
<!-- fIM dos Computadores NOTEBOOKS para DESENVOLVIMENTO iOS -->
