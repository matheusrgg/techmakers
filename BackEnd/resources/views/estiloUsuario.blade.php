          ...
          <div class="col-lg-4 col-md-6 mb-4">
                ...
                <div class="card h-100">
                  ...
                  <div class="card-footer">
                    <a href="/estiloUsuario/PCgamer" class="btn btn-success">Escolher...</a>
                  </div>
              </div>            
         </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                  ...
                  <div class="card-footer">
                    <a href="/estiloUsuario/UsoPessoal" class="btn btn-success">Escolher...</a>
                  </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                  ...
                  <div class="card-footer">
                    <a href="/estiloUsuario/UsoProfissional" class="btn btn-success">Escolher...</a>
                  </div>
              </div>
            </div>
