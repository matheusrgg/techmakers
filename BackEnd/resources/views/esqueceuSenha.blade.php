          ...
          <form class="">
            ...
            <div class="col-md-12 d-inline-flex justify-content-center">
              ...
              <!-- <a class="btn btn-success w-25 btn-lg" href="index.php" role="button">Enviar</a>  
                   ...
                   <a class="btn btn-success col-lg-4 col-md-4 col-sm-1 mt-2 mr-3 " href="\home" role="button">Enviar</a>
                   <a class="btn btn-success col-lg-4 col-md-4 col-sm-1 mt-2 ml-3" href="\home" role="button">Cancelar</a>
