      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 p-4 border rounded border-success">
            ...
            <form action="/novoUsuario" method="POST" enctype="multipart/form-data">
                  @csrf
                  @if(session("created"))
        ...
        <!--      <a class="btn btn-success col-lg-4 col-md-4 col-sm-1 mt-2 m-auto" href="#" role="button">Enviar</a>  -->
                  ...
                  <a class="btn btn-success col-lg-4 col-md-4 col-sm-1 mt-2 m-auto" href="\paineladm" role="button">Cancelar</a>
              </div>
            </form>
