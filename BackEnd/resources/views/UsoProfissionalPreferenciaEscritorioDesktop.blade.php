...
<div class="py-4 text-center text-white h-100 align-items-center d-flex"
    ...
    <div class="text-center">
      ...
      <div class="container-fluid pb-5">
          ...
          <nav>
            <div class="nav-wrapper">
              <div class="col s12 d-inline-flex align-items-center" style="margin:15px">
                ...
                <a class="breadcrumb p-0 m-0"><img class="d-block" src="/imagens/4p.jpg" width="35" height="35"></a>              </div>
          </div> 
          </nav>  
        ...
        <!-- Início dos Computadores desktop para ESCRITÓRIO usando ForEach -->
        <div class="container">
       ...
       <!--- Fim dos Computadores desktop para ESCRITÓRIO  usando ForEach --->
