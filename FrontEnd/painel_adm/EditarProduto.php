    ...
    ?>
     ...
     <main>
          ...
          <div class="row text-center container-fluid pb-3">
            <div class="col-md-12">
              <h1 class="text-success mt-2"><b>Editar Dados do Produto</b></h1>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <form>
              ...
              <a class="btn btn-success w-25 btn-lg" href="ListaProdutos.php" role="button">Atualizar</a>
              <a class="btn btn-success w-25 btn-lg ml-5" href="ListaProdutos.php" role="button">Cancelar</a>
            </form>
