    ...
    ?>
     ...
     <main>
          ...
          <div class="row text-center container-fluid pb-3">
            <div class="col-md-12">
              <h1 class="text-success mt-2"><b>Cadastrar Usuário</b></h1>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 p-4 border rounded border-success">
            <form>
              ...
              <a class="btn btn-success w-25 btn-lg" href="ListaUsuarios.php" role="button">Cadastrar</a>
              <a class="btn btn-success w-25 btn-lg ml-5" href="ListaUsuarios.php" role="button">Listar</a>
            </form>
          </div>
        </div>
      </div>
